$(document).ready(function () {
  ...
  $("#form_modificar_usuario").on("submit", function (e) {
    ...
    var parametros = new FormData($("#form_modificar_usuario")[0]);
    var btnEnviar = $("#btnEnviar_form_modificar_usuario");
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.isConfirmed) {
        ...
        $.ajax({
          data: parametros,
          url: "../sistema/logica/ajax_formularios/crud_usuarios/form_modificar_usuario.php",
          type: "POST",
          contentType: false,
          processData: false,
          success: function (data) {
            ...
            }, 2000); //hace redireccion despues de 3 segundos
          },
