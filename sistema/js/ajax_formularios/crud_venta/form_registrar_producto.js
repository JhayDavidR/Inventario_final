$(document).ready(function () {
  ...
  $("#form_registrar_producto").on("submit", function (e) {
    e.preventDefault();

    var parametros = new FormData($("#form_registrar_producto")[0]);
    var btnEnviar = $("#btnEnviar_form_registrar_producto");
    ...
    swalWithBootstrapButtons
      ...
      .then((result) => {
        if (result.isConfirmed) {
          $.ajax({
            data: parametros,
            url: "../sistema/logica/ajax_formularios/crud_venta/form_registrar_producto.php",
            type: "POST",
            contentType: false,
            processData: false,
            success: function (data) {
              ...
              $("body").append(data);
              // setTimeout(function () {
              //   location.reload("./././crud_usuarios/registrar_producto.php");
